// const apiKey = '1HbsxPPdBANmckaAM5KxFF9iiCm3C6g1vkkM1exIi'; // <-- insert your API key from https://multisynq.io/account here
// const apiKey = '2tY4BJ0rxQ1PFm3gv0IpKYdUsQ09jnYyVb799JTULh';
const apiKey = "2d0fPrsWoWQFrelRWB1TftMoNJLfOk4Ni6XkQvswX3"
export default { apiKey };

// NOTE: Multisynq API keys are "client-side" keys
